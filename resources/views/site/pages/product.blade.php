            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="single-banner-02">
                        <img src="{{ asset('assets/assets/images/banner/banner-04.jpg')}}" width="270" height="429" alt="Banner" />

                        <div class="banner-content">
                            <h3 class="title">
                                <a href="{{ route('product')}}">All New Furniture</a>
                            </h3>
                            <span class="discount">40% Off</span>
                            <a class="btn btn-primary btn-hover-dark" href="{{ route('product')}}">Shop Now</a>
                        </div>
                    </div>
                    <!-- Single Banner End -->
                </div>
